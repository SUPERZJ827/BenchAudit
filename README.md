...
|---|---:|---:|---:|
| Confirmed | 0.909 | 0.263 | 0.408 |
| Candidate | 0.800 | 0.737 | 0.767 |
| Priority candidate | 0.952 | 0.526 | 0.678 |

相较没有数量一致性审计的版本，Candidate F1 从 `0.676` 提升至 `0.767`，
Priority Recall 从 `0.158` 提升至 `0.526`。3 道人工修订错答案均进入候选集合。
